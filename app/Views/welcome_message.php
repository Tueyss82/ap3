...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= url_to('ajoutUtilisateur') ?>">ajout user (temporaire)</a></li>
            <li class="menu-item hidden"><a href="<?= url_to('message') ?>">gestion message (temporaire)</a></li>
