...
$routes->get('page_connexion', 'Home::connexion', ['as' => 'connexion']);

$routes->get('gestion_clients', 'Home::clients', ['as' => 'clients']);
...
$routes->get('gestion_utilisateur', 'Home::utilisateur', ['as' => 'utilisateur']);
